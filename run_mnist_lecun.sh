...
nohup python main.py --batch-size 64 --log-interval 100 --dataset mnist --model bernoulli  --epochs 1000 --input-size 784 --save-model --save-location "./checkpoints/mnist_bernoulli" --hidden-layers 300 > ./log/mnist/300.out 2> ./log/mnist/300.err & 
